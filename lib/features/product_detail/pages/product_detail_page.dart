...
///
/// - When [showAdminActions] is true, behaves like [AdminProductDetailPage]
/// - When [showAdminActions] is false, behaves like [CustomerProductDetailPage]
///
/// This class is kept for backward compatibility. New code should use
/// [AdminProductDetailPage] or [CustomerProductDetailPage] directly.
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: ProductDetailBody(
          ...
          showAdminActions: widget.showAdminActions,
          onEditPressed: widget.showAdminActions ? _editProduct : null,
          onDeletePressed: widget.showAdminActions ? _deleteProduct : null,
